...
export default async function Team() {
    ...
    console.log(member.results[0].phone);
        ...
        return (
        <div>
            <div className="flex overflow-hidden flex-col lg:flex-row justify-between items-center p-16 bg-[#dcabcd]">
            ...
            <div className="flex flex-col justify-center items-center max-sm:w-full bg-[#dcabcd]">
            ...
            <footer className="flex justify-between shadow-lg footer p-10 bg-[#facdec] ">
        <aside>
